...
import com.tencent.qcloud.xiaoshipin.videoeditor.paster.TCPasterInfo;
...
public class TCPasterSelectView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mTvAnimatedPaster.setTextColor(context.getResources().getColor(R.color.colorRed2));
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.tv_animated_paster) {
            ...
            currentTab = TAB_ANIMATED_PASTER;
            mTvAnimatedPaster.setTextColor(mContext.getResources().getColor(R.color.colorRed2));
            ...
            mTvPaster.setTextColor(mContext.getResources().getColor(R.color.colorRed2));
            if (mOnTabChangedListener != null) {
                mOnTabChangedListener.onTabChanged(currentTab);
            }
