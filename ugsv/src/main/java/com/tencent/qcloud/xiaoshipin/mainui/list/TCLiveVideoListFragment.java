 ...
 * 首页上下滑动展示视频页
 * 
 * CreatedBy hanshaobo in 2018/7/18
 */
public class TCLiveVideoListFragment extends Fragment implements ITXVodPlayListener {
    ...
    private TCLiveVideoListFragment.MyPagerAdapter mPagerAdapter;
    ...
    private void initPhoneListener() {
        if (mPhoneListener == null)
            mPhoneListener = new TCLiveVideoListFragment.TXPhoneStateListener(mTXVodPlayer);
...
//                mCurrentPosition = position;
        ...
        mVerticalViewPager.setPageTransformer(false, new ViewPager.PageTransformer() {
            ...
            public void transformPage(View page, float position) {
                ...
                TCLiveVideoListFragment.PlayerInfo playerInfo = mPagerAdapter.findPlayerInfo(mCurrentPosition);
                if (playerInfo != null) {
        ...
        mPagerAdapter = new TCLiveVideoListFragment.MyPagerAdapter();
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        ArrayList<TCLiveVideoListFragment.PlayerInfo> playerInfoList = new ArrayList<>();


        protected TCLiveVideoListFragment.PlayerInfo instantiatePlayerInfo(int position) {
            TXCLog.d(TAG, "instantiatePlayerInfo " + position);

            TCLiveVideoListFragment.PlayerInfo playerInfo = new TCLiveVideoListFragment.PlayerInfo();
            ...
            vodPlayer.setVodListener(TCLiveVideoListFragment.this);
        ...
        protected void destroyPlayerInfo(int position) {
            while (true) {
                TCLiveVideoListFragment.PlayerInfo playerInfo = findPlayerInfo(position);
                if (playerInfo == null)
                    break;
        ...
        public TCLiveVideoListFragment.PlayerInfo findPlayerInfo(int position) {
            for (int i = 0; i < playerInfoList.size(); i++) {
                TCLiveVideoListFragment.PlayerInfo playerInfo = playerInfoList.get(i);
        ...
        public TCLiveVideoListFragment.PlayerInfo findPlayerInfo(TXVodPlayer player) {
            for (int i = 0; i < playerInfoList.size(); i++) {
                TCLiveVideoListFragment.PlayerInfo playerInfo = playerInfoList.get(i);
        ...
        public void onDestroy() {
            for (TCLiveVideoListFragment.PlayerInfo playerInfo : playerInfoList) {
                playerInfo.txVodPlayer.stopPlay(true);
            }
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(TCLiveVideoListFragment.this).load(tcLiveInfo.headpic).error(R.drawable.face).into(ivAvatar);
            // 姓名
            ...
            TCLiveVideoListFragment.PlayerInfo playerInfo = instantiatePlayerInfo(position);
...
//    }
    ...
    public void onPlayEvent(TXVodPlayer player, int event, Bundle param) {
        if (event == TXLiveConstants.PLAY_EVT_CHANGE_RESOLUTION) {
            ...
            TCLiveVideoListFragment.PlayerInfo playerInfo = mPagerAdapter.findPlayerInfo(player);
            if (playerInfo != null) {
                        ...
                        public void run() {
                            if (retCode == 0) {
                                if (result != null) {
                                    ...
                                    Log.d("hsb","获取到数据："+mVideoList.size());
