package com.tencent.qcloud.xiaoshipin.common.widget.beautysetting;
...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        //获取自定义属性和默认值
        bgColor = mTypedArray.getColor(R.styleable.RoundProgressBar_bgColor, Color.TRANSPARENT);
        roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor, Color.RED);
        roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundProgressColor, Color.GREEN);
        textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_textColorP, Color.GREEN);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(center, center, center, paint); //画出圆环
        ...
        switch (style) {
            case STROKE: {
                ...
                float arcOffset = -90;
                canvas.drawArc(oval, 0 + arcOffset, 360 * progress / max, false, paint);  //根据进度画圆弧
                break;
            }
            case FILL: {
