...
import com.tencent.qcloud.xiaoshipin.videojoiner.widget.swipemenu.ResCompat;
...
public class ListViewDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListViewDecoration() {
        mDrawable = ResCompat.getDrawable(TCApplication.getApplication(), R.drawable.swipe_menu_divider_recycler);
    }
