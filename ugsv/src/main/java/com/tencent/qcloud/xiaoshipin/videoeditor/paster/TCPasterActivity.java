...
public class TCPasterActivity extends Activity implements View.OnClickListener,
    ...
    private boolean mIsUseReverse;    // 外部是否使用了倒放
    ...
    private void initViews() {
        ...
        mVideoProgressView.setThumbnailData(mThumbnailList);
    ...
    private void resumePlay() {
        ...
        if (mCurrentState == STATE_PAUSE) {
            ...
            mTXVideoEditer.startPlayFromTime(mPreviewAtTime, mCutterEndTime);
        }
